...
INSERT INTO `users`(`id`,`firstName`,`lastname`,`password`,`email`,`role`) VALUES ( '1', 'Administrador', 'Admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin@admin.com', 'admin' );
COMMIT;
-- ---------------------------------------------------------
...
INSERT INTO `workshops`(`id`,`title`,`description`,`begin_date`,`end_date`) VALUES ( '1', 'MEAN Stack', 'Curso para aprender sobre Mongo, Express, Angular y Node (MEAN)', '2015-02-11', '2015-02-12' );
INSERT INTO `workshops`(`id`,`title`,`description`,`begin_date`,`end_date`) VALUES ( '2', 'Angular JS', 'Nuevo curso de Angular', '2015-02-16', '2015-02-16' );
COMMIT;
-- ---------------------------------------------------------
